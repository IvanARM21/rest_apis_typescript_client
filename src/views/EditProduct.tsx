  ...
  return (
    <>
        <div className="flex justify-between flex-col items-center gap-5 sm:flex-row mb-5">
            <h2 className="text-4xl font-black text-slate-500 text-center">Editar Producto</h2>
            <Link
                to="/"
        ...
        >
            ...
            <div className="mb-4">
                ...
                <select 
                    id="availability"
                    className="mt-2 block w-full p-3 bg-gray-100 shadow-md rounded-2xl focus:bg-gray-200 transition-colors"
                    name="availability"
